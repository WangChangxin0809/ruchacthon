...
run unit "claim conflicts decided"   python3 scripts/gates/check_escalation_decisions.py
run unit "workbench mechanics (no Claude Code needed)" python3 backend/tests/test_workbench.py
